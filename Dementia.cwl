...
steps:
  ...
  dementia-assessment---primary:
    run: dementia-assessment---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-rating---primary:
    run: dementia-rating---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-assessment---primary/output
  clinical-dementia---primary:
    run: clinical-dementia---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-rating---primary/output
  dementia-alzheimer's---primary:
    run: dementia-alzheimer's---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: clinical-dementia---primary/output
  clinic-dementia---primary:
    run: clinic-dementia---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-alzheimer's---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: clinic-dementia---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
